...
public class Camera {
   ...
   public void drawMap(int offsetX, int offsetY) {
       ...
       map.render(   
             ...
             tileIndexX,  
             tileIndexY,
                (gc.getWidth()  - tileOffsetX) / tileWidth  + 100,
                (gc.getHeight() - tileOffsetY) / tileHeight + 100);
   }
   ...
   public void translateGraphics() {
      ...
      //gc.getGraphics().scale(scale, scale);
   }
   /**
   ...
   public Vector getCameraVector(){
       return new Vector(- (cameraX % tileWidth), - (cameraY % tileHeight) );
   }
